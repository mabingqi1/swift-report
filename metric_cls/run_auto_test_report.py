...
default_abnorm_list = [
  '囊肿', '大脑镰下疝', '小脑幕切迹疝', '小脑扁桃体疝', '水肿', '破入脑室',
  '硬膜下积液', '硬膜下血肿', '硬膜外血肿', '缺血性白质病变', '脂肪瘤', '脑出血', '脑挫裂伤', '脑梗死', '脑疝',
  '脑肿物', '脑萎缩', '腔隙性脑梗死', '蛛网膜下腔出血', '软化灶', '钙化', '颅外疝'
]

default_prompt_template = """
根据医生颅脑报告从给定的疾病列表中找到病人所患的疾病，并输出一个疾病组成的json格式list，例如["xxx","xxx"]。
注意：
- 只输出列表不输出其他，严格使用疾病列表中的疾病名字。
- 报告中的疾病带解剖部位，要去掉解剖部位后与疾病列表匹配。
- 疾病名字可能与列表中的不一样，要进行一定程度分析。
- 老年脑等价于脑萎缩。
- 缺血性脑白质病变属于缺血性白质病变。
- 脑水肿属于水肿。
